...
6. **Docs** — for library modules with public APIs, add KDoc directly following Kotlin documentation conventions (no dedicated docs agent for Kotlin yet).
